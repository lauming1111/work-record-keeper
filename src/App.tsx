...
export default function App(): JSX.Element {
  ...
  const labels = {
    en: {
      ...
      privacyPage: "Privacy & Storage",
      termsPage: "Terms & Disclaimer",
  ...
  return (
    <div className={`big-container ${darkMode ? "dark" : "light"}`}>
      ...
      <div className="disclaimer">
        ...
        <br />
        <span>{labels[lang].privacyLine}</span>
        <br />
        ...
        <span className="legal-links">
          <a href={`${process.env.PUBLIC_URL}/privacy.html`}>{labels[lang].privacyPage}</a>
